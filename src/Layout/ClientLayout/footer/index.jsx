        ...
        <footer className="mx-auto px-5 xl:px-20 pt-5 border border-t-gray-300 border-b-0">
            <div className="footer__row  grid grid-cols-1 lg:grid-cols-4 py-3 lg:py-8 gap-5 lg:gap-5 xl:gap-20">
                <div>
                    ...
                    />
                    <h3 className="uppercase font-bold text-2xl">LUXURY STORE</h3>
            ...
            <p className="border border-t-gray-300 border-b-0 border-l-0 border-r-0 text-sm font-semibold text-[#888888] py-2">Copyright ⓒ 2023 by LUXURY STORE</p>
        </footer>
    );
};
